...
import { Info, Loader2, RefreshCw, TrendingUp, Lock, Clock, CircleDollarSign, ShieldCheck } from "lucide-react";
...
export function VaultsTab() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* How LP Collateral Vaults work — always-visible reference */}
      <section className="space-y-5 border-t border-white/5 pt-8">
        <div>
          <h3 className="text-base font-semibold text-white">How LP Collateral Vaults work</h3>
          <p className="mt-1 text-sm text-gray-400">Everything worth knowing before you open a position.</p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Panel key={i} className="p-5">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-magnet-600 to-magnet-800 text-white">{f.icon}</div>
              <p className="text-sm font-semibold text-white">{f.title}</p>
              <p className="mt-1.5 text-xs leading-relaxed text-gray-400">{f.body}</p>
            </Panel>
          ))}
        </div>
        ...
        <Panel className="p-6">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={r.band} className="flex flex-col gap-1.5 rounded-lg border border-white/5 bg-black/20 p-3 sm:flex-row sm:items-center sm:gap-4">
          ...
          <div className="mt-4 flex items-start gap-2 rounded-lg border border-white/5 bg-black/30 px-3 py-2.5">
